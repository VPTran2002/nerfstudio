...
@dataclass
class TrainerSegmentAfterRGBConfig(ExperimentSegmentConfig):
    """Configuration for training regimen"""

    _target: Type = field(default_factory=lambda: TrainerSegmentAfterRGB)
...
class TrainerSegmentAfterRGB:
    ...
    def __init__(self, config: TrainerSegmentAfterRGBConfig, local_rank: int = 0, world_size: int = 1) -> None:
