...
@dataclass
class TrainerSegmentConfig(ExperimentSegmentConfig):
    """Configuration for training regimen"""

    _target: Type = field(default_factory=lambda: TrainerSegment)
...
class TrainerSegment:
    ...
    def __init__(self, config: TrainerSegmentConfig, local_rank: int = 0, world_size: int = 1) -> None:
